...
const featuresData: Feature[] = [
  {
    id: 1,
    icon: (
      <svg width="40" height="41" viewBox="0 0 40 41" className="text-white fill-current">
        <path
          opacity="0.5"
    ...
    title: "Praktisi",
    paragraph:
      "Tipe yang berorientasi pada praktik nyata, senang bekerja langsung di lapangan, dan mampu menyelesaikan masalah konkret. Cocok untuk profesi yang membutuhkan keterampilan teknis dan kecepatan dalam bertindak.",
  },
  {
    id: 2,
    icon: (
    ...
    title: "Akademisi",
    paragraph:
      "Tipe yang gemar menganalisis, meneliti, dan mengembangkan pengetahuan. Memiliki rasa ingin tahu tinggi serta kecenderungan berpikir kritis. Cocok untuk bidang pendidikan, penelitian, atau profesi yang menuntut kedalaman teori.",
  },
  {
    id: 3,
    icon: (
    ...
    paragraph:
      "Tipe yang inovatif, menyukai tantangan baru, dan senang menciptakan ide-ide segar. Fleksibel serta terbuka pada berbagai kemungkinan. Cocok di bidang seni, desain, media, maupun pekerjaan yang menuntut inovasi.",
  },
  {
    id: 4,
    icon: (
      <svg width="40" height="45" viewBox="0 0 40 45" className="text-white fill-current">
        <path
          opacity="0.5"
    ...
    title: "Wirausaha",
    paragraph:
      "Tipe yang visioner, berani mengambil risiko, dan percaya diri dalam memimpin. Mampu melihat peluang serta menggerakkan orang lain untuk mencapai tujuan. Cocok di dunia bisnis, organisasi, maupun kepemimpinan.",
  },
];
