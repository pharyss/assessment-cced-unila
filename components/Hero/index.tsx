            ...
            <div className="w-full px-4">
              ...
              >
                <h1 className="mb-5 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                  Pahami Talenta, Persiapkan Masa Depan!
                </h1>
                <p className="dark:text-white mb-8 text-base !leading-relaxed text-body-color sm:text-lg md:text-xl">
                  Siapkan karier impianmu mulai dari sekarang! Dengan Asesmen Talenta Universitas Lampung, kamu bisa mengenali karakteristik, minat, dan potensi terbaik dalam dirimu.
                </p>
