    ...
    <>
      ...
      >
            ...
            <div className="w-full px-4">
              ...
              >
                <h1 className="mb-5 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                  Kenali Potensi Dirimu, Raih Masa Depan yang Lebih Terarah
                </h1>
                <p className="dark:text-body-color-dark mb-8 text-base !leading-relaxed text-body-color sm:text-lg md:text-xl">
                  Lebih dari ribuan mahasiswa Universitas Lampung sudah mengikuti tes ini untuk mengenali potensi diri, minat, dan bakat mereka. Sekarang giliran kamu! Yuk, coba sekarang dan temukan hasilnya secara langsung.
                </p>
        ...
        <div className="absolute right-0 top-0 z-[-1] opacity-30 lg:opacity-100" >
          <Image src="/images/hero/hero-bg.png" 
