...
export default function TalentResultPage() {
  ...
  const { getFinalResult } = useAssessmentLogic();
  ...
  useEffect(() => {
    try {
      ...
      const final = saved ? getFinalResult(JSON.parse(saved)) : getFinalResult();
      setResult(final);
    } catch (err) {
    ...
    <section className="relative z-10 bg-gradient-to-b from-white via-myunila-50 to-myunila-100 pb-20 pt-20 dark:from-gray-950 dark:via-gray-900 dark:to-gray-800 sm:pb-24 sm:pt-32 md:pb-[120px] md:pt-[150px]">
      ...
      <div className="text-center">
        <p className="text-sm text-gray-500 dark:text-gray-400">
          ...
          kepribadian kamu. Gunakan hasil ini sebagai bahan refleksi diri dan
          pengembangan karir ke depan.
        </p>
      </div>
      </div>
    </div>
